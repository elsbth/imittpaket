...
Route::get('/admin/users/{userId}','AdminController@users')->name('admin.users.userid')->middleware('admin');
...
Route::get('/admin/faq/edit/{id}','Admin\FaqController@edit')->name('admin.faq.edit')->middleware('admin');
...
Route::get('/faq/{id?}', 'FaqController@index')->name('faq');
